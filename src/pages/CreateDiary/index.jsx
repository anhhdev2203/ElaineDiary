    ...
    <>
      ...
      >
        <Container sx={{ maxWidth: "xl" }}>
          ...
          {/* <Modal
            ...
            >
              ...
              >
                ...
                <Typography>Mã chia sẻ</Typography>
                <Typography>{diary.shareCode}</Typography>
          ...
          >
            <DialogTitle id="alert-dialog-title">{"Xem mã code"}</DialogTitle>
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Mã code của bạn là: {diary.shareCode}
              </DialogContentText>
            </DialogContent>
            <DialogActions>
              <Button onClick={toggleMenu} autoFocus>
                Đóng
              </Button>
            </DialogActions>
          </Dialog>
